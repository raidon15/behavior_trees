  ...
  void * untyped_ros_message)
{
  ...
  _Sleep_Goal__ros_msg_type * ros_message = static_cast<_Sleep_Goal__ros_msg_type *>(untyped_ros_message);
  // Field name: msec_timeout
  {
    cdr >> ros_message->msec_timeout;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _Sleep_Result__ros_msg_type * ros_message = static_cast<_Sleep_Result__ros_msg_type *>(untyped_ros_message);
  // Field name: done
  {
    uint8_t tmp;
    cdr >> tmp;
  ...
  void * untyped_ros_message)
{
  ...
  _Sleep_Feedback__ros_msg_type * ros_message = static_cast<_Sleep_Feedback__ros_msg_type *>(untyped_ros_message);
  // Field name: cycle
  {
    cdr >> ros_message->cycle;
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, btcpp_ros2_interfaces, action, Sleep_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _Sleep_SendGoal_Request__ros_msg_type * ros_message = static_cast<_Sleep_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  void * untyped_ros_message)
{
  ...
  _Sleep_SendGoal_Response__ros_msg_type * ros_message = static_cast<_Sleep_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: accepted
  {
    uint8_t tmp;
    cdr >> tmp;
  ...
  void * untyped_ros_message)
{
  ...
  _Sleep_GetResult_Request__ros_msg_type * ros_message = static_cast<_Sleep_GetResult_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, btcpp_ros2_interfaces, action, Sleep_Result
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _Sleep_GetResult_Response__ros_msg_type * ros_message = static_cast<_Sleep_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: status
  {
    cdr >> ros_message->status;
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, btcpp_ros2_interfaces, action, Sleep_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _Sleep_FeedbackMessage__ros_msg_type * ros_message = static_cast<_Sleep_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
