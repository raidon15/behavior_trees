...
_colcon_package_sh_COLCON_CURRENT_PREFIX="/home/benjamin/BT_ws/install/behaviortree_cpp"
...
# source sh hooks
_colcon_package_sh_source_script "$COLCON_CURRENT_PREFIX/share/behaviortree_cpp/hook/cmake_prefix_path.sh"
